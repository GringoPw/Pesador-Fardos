...
class VentanaPrincipal:
    ...
    def crear_barra_estado(self):
        ...
        # Estado de la balanza - cambiar texto por defecto
        estado_balanza = "Real" if not BALANZA_CONFIG['simular_balanza'] else "Simulada"
        color_balanza = COLORES['activo'] if not BALANZA_CONFIG['simular_balanza'] else COLORES['advertencia']
        
        self.indicador_balanza = EstilosModernos.crear_indicador_estado(
            self.barra_estado, f"Balanza: {estado_balanza}", color_balanza)
        ...
        self.label_estado = tk.Label(self.barra_estado, 
                                text="Sistema listo - Balanza real configurada",
