...
class VentanaAcercaDe:
    ...
    def crear_seccion_desarrollador(self, parent):
        ...
        # Nombre
        self.crear_campo_info(info_frame, "Nombre:", "Desarrollador del Sistema de Pesaje")
        
        # Teléfono
        self.crear_campo_info(info_frame, "Teléfono:", "+54 9 11 1234-5678")
        
        # Email
        email = "contacto@sistemapesaje.com"
    ...
    def crear_seccion_sistema(self, parent):
        ...
        # Versión
        self.crear_campo_info(info_frame, "Versión:", "2.0")
        
        # Fecha de actualización
        self.crear_campo_info(info_frame, "Última actualización:", "Junio 2024")
        
        # Licencia
        self.crear_campo_info(info_frame, "Licencia:", "Uso exclusivo para Sistema de Pesaje")
